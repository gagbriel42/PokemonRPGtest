...
export function getHgssSpriteCandidates(pokemon,side='front'){const id=getPokemonDexId(pokemon);if(!id)return[];return side==='back'?[`${spriteRoot}/versions/generation-iv/heartgold-soulsilver/back/${id}.png`,`${spriteRoot}/back/${id}.png`]:[`${spriteRoot}/versions/generation-iv/heartgold-soulsilver/${id}.png`,`${spriteRoot}/${id}.png`]}
