...
function CharacterSprite({src,palette="npc-blue",direction="down"}){const row={down:0,left:1,right:2,up:3}[direction]??0;return <span className={`character-sprite ${palette}`}style={{backgroundImage:`url(${src})`,backgroundPosition:`0 -${row*32}px`}}/>}
