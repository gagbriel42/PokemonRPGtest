...
function CharacterSprite({src,palette="npc-blue",direction="down"}){const row={down:0,up:1,left:2,right:3}[direction]??0;return <span className={`character-sprite ${palette}`}style={{backgroundImage:`url(${src})`,backgroundPosition:`0 -${row*96}px`}}/>}
